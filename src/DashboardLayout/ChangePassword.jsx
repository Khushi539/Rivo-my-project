...
import { ChangePassword } from "../API/productapi";
...
const ChangePasswords = () => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-gray-50 md:px-4">
      <div className=" w-full bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <div className="bg-[#DFF5E6] p-6 text-center text-[#0D542B]">
          <div className="inline-flex p-3 bg-white/20 rounded-full mb-3">
            <ShieldCheck size={32} />
          </div>
          <h2 className="text-2xl font-bold">Security Settings</h2>
          <p className="text- text-sm mt-1">Update your administrative password</p>
        </div>

        <form onSubmit={handleSubmit} className="md:p-8 p-2 space-y-5">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                className="w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition"
              />
              <button
                type="button"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute inset-y-0 right-0 pr-3 flex items-center text-[#0D542B] "
              >
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full py-3 rounded-lg font-medium text-black shadow-md transition transform active:scale-[0.98] ${
              loading ? "bg-gray-400 cursor-not-allowed" : "bg-[#DFF5E6] hover:opacity-90 cursor-pointer hover:shadow-lg"
            }`}
          >
            {loading ? (
